...
class TTSModel: ObservableObject {
...
#if DEBUG
    @available(*, deprecated, renamed: "init(tts:)", message: "only use this initializer for previews")
    init() {
   ...
   // MARK: - TTS Integration
    ...
    func postSynchronousJson(text: String, voiceDescription: String, speed: Double, trailingSilence: Double, format: Format) async throws {
        // Build request
        let postedUtterances: [PostedUtterance] = [makeUtterance(text: text, voiceDescription: voiceDescription, speed: speed, trailingSilence: trailingSilence)]
    ...
    func postSynchronousFile(text: String, voiceDescription: String, speed: Double, trailingSilence: Double, format: Format) async throws {
        // Build request
        let postedUtterances: [PostedUtterance] = [makeUtterance(text: text, voiceDescription: voiceDescription, speed: speed, trailingSilence: trailingSilence)]
        let request = makePostedTts(postedUtterances: postedUtterances, format: format)
    ...
    func streamJson(text: String, voiceDescription: String, speed: Double, trailingSilence: Double, format: Format) async throws {
        let postedUtterances: [PostedUtterance] = [makeUtterance(text: text, voiceDescription: voiceDescription, speed: speed, trailingSilence: trailingSilence)]
        let request = makePostedTts(postedUtterances: postedUtterances, format: format)
    ...
    func streamFile(text: String, voiceDescription: String, speed: Double, trailingSilence: Double, format: Format) async throws {
        // build request
        let postedUtterances: [PostedUtterance] = [makeUtterance(text: text, voiceDescription: voiceDescription, speed: speed, trailingSilence: trailingSilence)]
        let request = makePostedTts(postedUtterances: postedUtterances, format: format)
    ...
    private func makeUtterance(text: String, voiceDescription: String, speed: Double, trailingSilence: Double) -> PostedUtterance {
        PostedUtterance(
            description: voiceDescription,
            speed: speed,
            trailingSilence: trailingSilence,
            text: text,
            voice: .postedUtteranceVoiceWithId(PostedUtteranceVoiceWithId(
